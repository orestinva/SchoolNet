...
@Injectable()
export class ScheduleMySuffixService {

    private resourceUrl = 'api/schedules';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(schedule: ScheduleMySuffix): Observable<ScheduleMySuffix> {
    ...
    update(schedule: ScheduleMySuffix): Observable<ScheduleMySuffix> {
        const copy: ScheduleMySuffix = Object.assign({}, schedule);
    ...
    find(id: number): Observable<ScheduleMySuffix> {
