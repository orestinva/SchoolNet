...
export class ClassroomMySuffixService {
    ...
    create(classroom: ClassroomMySuffix): Observable<ClassroomMySuffix> {
    ...
    update(classroom: ClassroomMySuffix): Observable<ClassroomMySuffix> {
        const copy: ClassroomMySuffix = Object.assign({}, classroom);
    ...
    find(id: number): Observable<ClassroomMySuffix> {
