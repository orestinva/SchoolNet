...
public class SchoolResourceIntTest {
    ...
    public void createSchool() throws Exception {
        ...
        assertThat(testSchool.isEnabled()).isEqualTo(DEFAULT_ENABLED);
    }
    ...
    public void updateSchool() throws Exception {
        ...
        SchoolDTO schoolDTO = schoolMapper.schoolToSchoolDTO(updatedSchool);
        ...
        assertThat(testSchool.isEnabled()).isEqualTo(UPDATED_ENABLED);
    }
